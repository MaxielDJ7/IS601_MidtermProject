        ...
        while True:
            try:
                ...
                if command == 'help':
                    ...
                    print("\nAvailable commands:")
                    print("  add, subtract, multiply, divide, power, root, percent, absolutediff, intdivide - Perform calculations")
                ...
                if command in ['add', 'subtract', 'multiply', 'divide', 'power', 'root','percent','absolutediff','intdivide']:
